...
const (
	...
	TaskService_FindTask_FullMethodName   = "/task.TaskService/FindTask"
...
func (c *taskServiceClient) FindTask(ctx context.Context, in *FindTaskRequest, opts ...grpc.CallOption) (*FindTaskResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaskService_FindTask_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TaskService_FindTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaskService_FindTask_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
